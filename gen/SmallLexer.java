...
public class SmallLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "LINE_COMMENT", "ELSEIF", "ENDIF", "ENDWHILE", "ENDFOR", "ENDSUB", 
			"GOTO", "IF", "THEN", "ELSE", "WHILE", "FOR", "SUB", "TO", "STEP", "TRUE", 
			"FALSE", "TEXT_WINDOW", "STACK", "PROGRAM", "ARRAY", "OR", "AND", "COLON", 
			"MINUS", "PLUS", "TIMES", "DIV", "COMMA", "PERIOD", "LESS", "GREATER", 
			"EQUALS", "LEQ", "GEQ", "DIFF", "LEFT_BRAC", "RIGHT_BRAC", "LEFT_PAREN", 
			"RIGHT_PAREN", "STR", "NUM", "ID"
		};
	}
